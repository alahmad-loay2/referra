...
import {
  fetchEmployeeReferralDetails,
  editCandidate,
  deleteCandidate,
} from "../../../api/employeeReferrals.api";
import Loading from "../../../components/loading/Loading";
import "./EmployeeReferralHD.css";
// Employee Referral History Details page that shows detailed information about a
//  specific referral, including the candidate's name, email, phone number, years of experience, CV, position details , and application progress timeline.
const STATUS_ORDER = [
  "Pending",
  "Confirmed",
  "InterviewOne",
...
const EmployeeReferralHD = () => {
  ...
  const handleDelete = async () => {
    if (
      !referralData?.Candidate?.CandidateId ||
      referralData?.Referral?.Status !== "Pending"
    )
      return;
  ...
  if (error || !referralData) {
    return (
      <div className="referral-hd-container">
        <Link
          to="/dashboard/employee/my-referrals"
          className="referral-hd-back-link"
        >
          <ArrowLeft size={18} />
          Referral Details
        </Link>
      ...
      <div className="referral-hd-container">
        <div className="referral-hd-header">
          <div className="referral-hd-header-left">
            ...
            <p>View and manage your referral details.</p>
          </div>
          {!isEditMode && (
          ...
          <div className="emp-referral-hd-content-left">
            ...
            <div className="emp-referral-candidate-information">
              ...
              <div className="emp-referral-cv-section">
                {!isEditMode && Candidate.CVUrl ? (
                  ...
                  <div
                    ...
                    onClick={() =>
                      document.getElementById("cvUploadEdit").click()
                    }
                  >
                    ...
                    {cvError && (
                      <p className="emp-referral-error-text">{cvError}</p>
                    )}
                    <input
                      id="cvUploadEdit"
                      type="file"
              ...
              <div className="emp-referral-candidate-info-actions">
                {!isEditMode ? (
                  <button className="referral-hd-edit-btn" onClick={handleEdit}>
                    Edit
                  </button>
                ) : (
                  <>
      ...
      {showSaveConfirm && (
        <div className="referral-hd-modal-overlay">
          <div className="referral-hd-modal">
            <h3>Save changes?</h3>
            <p>
              Are you sure you want to save these changes? The candidate
